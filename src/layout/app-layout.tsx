...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['club-owner', 'club-member', 'event-manager', 'ticketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Ticket', path: '/tickets', entity: 'ticket', service: AccessServiceEnum.PROJECT, icon: FiBox },
